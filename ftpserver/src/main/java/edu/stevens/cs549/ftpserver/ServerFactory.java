		...
		IServerFactory
{
	...
	/*
	 * Specify host (IP address) for multi-homed hosts. Specify port of server
	 * for allowing access through a firewall.
	 */
	...
	public ServerFactory(InetAddress h, int port, String p)
